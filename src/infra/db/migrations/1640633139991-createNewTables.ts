...
export class createNewTables1640633139991 implements MigrationInterface {
    name = 'createNewTables1640633139991'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "wishlist" ("id" SERIAL NOT NULL, "price" integer NOT NULL, "image" character varying NOT NULL, "brand" character varying NOT NULL, "product_id" character varying NOT NULL, "title" character varying NOT NULL, CONSTRAINT "PK_620bff4a240d66c357b5d820eaa" PRIMARY KEY ("id"))`);
